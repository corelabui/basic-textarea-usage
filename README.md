# FormFusion - Basic Textarea usage

This repository contains a simple example of using the Textarea component with built-in validation from the FormFusion [library](https://www.corelabui.com/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/corelabui/basic-textarea-usage.git
   ```

2. Install dependencies:

   ```bash
   cd basic-textarea-usage
   npm install
   ```
